...
INSERT INTO data_pools (name, slug, description, industry, target_audience, platform, creative_format, data_points, contributors, avg_success_rate)
VALUES 
  ('E-commerce Fashion Insights', 'ecommerce-fashion', 'Performance patterns from fashion/apparel ads targeting millennials and Gen Z', 'ecommerce', 'millennials', 'instagram', 'ugc', 1250, 45, 72.5),
  ('SaaS B2B Lead Generation', 'saas-b2b-leads', 'Ad performance data optimized for B2B software lead generation', 'saas', 'b2b', 'facebook', 'testimonial', 890, 32, 68.3),
  ('TikTok Viral Patterns', 'tiktok-viral', 'Insights from viral TikTok ads across multiple industries', 'ecommerce', 'gen_z', 'tiktok', 'ugc', 2100, 78, 81.2),
  ('High-Ticket Services', 'high-ticket-services', 'Ad patterns for premium/high-ticket service offerings', 'local_services', 'high_income', 'facebook', 'founder_led', 560, 21, 64.8),
  ('Health & Wellness DTC', 'health-wellness-dtc', 'Direct-to-consumer health product advertising insights', 'health', 'millennials', 'multi', 'product_demo', 980, 38, 69.7)
